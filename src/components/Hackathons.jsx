...
import sasLogo from '../assets/projects/SAS.png';
...
const HACKS = [
  {
    ...
    description:
      'National-level quantum computing hackathon. First major deep-tech competition at VIT.',

    hackathonLines: [
      '1ST PLACE — NATIONAL LEVEL',
      'IBM Qiskit Fall Fest 2024',
      '',
      'Won during Semester 1, Year 1 at VIT.',
      '',
      'Competed against participants from across India',
      'in one of the earliest quantum-focused hackathons',
      'I participated in.',
      '',
      'Quantum computing’s emerging landscape enabled',
      'first-year students to compete alongside senior',
      'developers and researchers.',
      '',
      'First major entry into research-oriented',
      'deep-tech competitions.',
    ],
    ...
    projectLines: [
      ...
      '',
      'Developed a QBMS framework leveraging',
      'QAOA and VQE-based optimization workflows',
      'for a proprietary battery management',
      'hardware architecture.',
      '',
      'Theoretical simulations indicated:',
      '  · Reduced static power overhead',
      '  · Improved energy optimization',
      '  · Enhanced battery efficiency',
      '',
      'Integrated quantum optimization concepts',
      'with electronics and energy systems.',
      '',
      'NDA restrictions apply to implementation',
...

  {
    ...
    description:
      'International quantum computing event with participants from 10+ countries.',

    hackathonLines: [
      'INTERNATIONAL QUANTUM HACKATHON',
      'IBM Qiskit Fall Fest 2025',
      '',
      'Served as Host, Judge, and Teaching Instructor',
      'for a week-long international event.',
      '',
      'Participants represented 10+ countries across',
      'multiple technical and cultural backgrounds.',
      '',
      'Facilitated cross-cultural collaboration within',
      'a globally distributed quantum computing cohort.',
      '',
      'Transitioned from participant to contributor',
      'within the international quantum ecosystem.',
    ],

    projectLines: [
      'CONTRIBUTIONS & LEADERSHIP',
      '',
      'Conducted instructional sessions on:',
      '  · Quantum computing fundamentals',
      '  · Quantum programming workflows',
      '  · Qiskit framework usage',
      '  · Applied quantum problem-solving',
      '',
      ...
      '',
      'Strengthened experience in mentoring,',
...

  {
    ...
    sprite: '📊',
    hp: 90,
    logos: [intelLogo, microsoftLogo, sasLogo],
    bgComponent: AbstractColorfulBg,
    hueShift: 180,

    description:
      'Enterprise-scale analytics competition focused on predictive optimization and decision systems.',

    hackathonLines: [
      'WORLD RANK 19',
      'SAS × Microsoft × HEC Montréal 2025',
      '',
      'Premier international analytics competition',
      'centered around enterprise-scale optimization.',
      '',
      'Focused on:',
      ...
      '  · Strategic analytics',
      '',
      'Ranked among top global participants solving',
      'real-world operational decision problems.',
    ],

    projectLines: [
      'PROJECT: FUNDRAISING OPTIMIZATION',
      '',
      'Designed predictive analytics workflows',
      ...
      '',
      'Worked extensively with large structured',
      'datasets and business-oriented analytics.',
      '',
      'Awarded SAS Workbench access and official',
      'recognition for securing a global top-20 rank.',
    ],
...

  {
    ...
    description:
      'Hardware-focused engineering challenge centered on analog electronics and circuit systems.',

    hackathonLines: [
      'RANK 5',
      'Analog Circuits Hackathon — Trivandrum',
      '',
      'Only hardware-focused hackathon I have',
      'participated in.',
      '',
      ...
      '',
      'Provided hands-on experience with practical',
      'hardware engineering workflows.',
    ],

    projectLines: [
      'PROJECT: ANALOG CIRCUIT SYSTEMS',
      '',
      'Designed and tested operational amplifier',
      'based analog electronic systems.',
      '',
      'Work included:',
      ...
      '',
      'Strong blend of mathematics, electronics,',
      'and practical hardware problem-solving.',
    ],
...

  {
    ...
    description:
      'Quantitative finance competition focused on alpha-generation and financial modeling.',

    hackathonLines: [
      'ALL INDIA RANK 163',
      'Goldman Sachs Quantitative Finance 2024',
      '',
      'Highly competitive challenge centered around',
      'quantitative finance and analytical modeling.',
      '',
      'Performance rankings were determined by',
      'the effectiveness of generated alpha models.',
      '',
      'Served as an early gateway into:',
      '  · Data science',
      '  · Financial analytics',
    ...
    projectLines: [
      'PROJECT: ALPHA GENERATION SYSTEMS',
      '',
      'Developed quantitative strategies focused on',
      'performance-driven financial prediction.',
      '',
      'Core work involved:',
      '  · Quantitative data analysis',
      '  · Strategy optimization',
      '  · Financial forecasting systems',
      '  · Market-oriented modeling',
      '  · Analytical performance evaluation',
      '',
      'Established the foundation for later work',
      'in enterprise analytics and data science.',
    ],
